            ...
            <div class="col-12">
                <div class="card shadow-sm mb-2">
                    <div class="card-body py-3 d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0 fw-bold">Tambah User</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body pt-4 pb-4">
                        ...
                        <form id="formUser" action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // SweetAlert Error jika ada validasi gagal
    @if ($errors->any())
        Swal.fire({
            icon: "error",
            title: "Gagal!",
