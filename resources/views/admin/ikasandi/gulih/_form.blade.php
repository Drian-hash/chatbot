...
<div class="row form-compact">
    ...
    <div class="col-md-6 form-group">
        ...
        <input type="text" name="kode_soal" class="form-control shadow-sm"
            value="{{ old('kode_soal', $edit ? $item->kode_soal : '') }}" required>
    ...
    <div class="col-md-12 form-group">
        ...
        <textarea name="pertanyaan" class="form-control shadow-sm" required>{{ old('pertanyaan', $edit ? $item->pertanyaan : '') }}</textarea>
