...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const input = document.getElementById("fotoInput{{ $edit ? $user->id : 'new' }}");
        const fileName = document.getElementById("fileName{{ $edit ? $user->id : 'new' }}");
        ...
        if (input) {
            ...
            input.addEventListener("change", function() {
                ...
                if (input.files.length > 0) {
                    ...
                    fileName.innerText = "File dipilih: " + input.files[0].name;
